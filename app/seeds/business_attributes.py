...
def undo_business_attributes():
    if environment == "production":
        db.session.execute(f"TRUNCATE table {SCHEMA}.business_attributes RESTART IDENTITY CASCADE;")
    else:
        db.session.execute("DELETE FROM business_attributes")
